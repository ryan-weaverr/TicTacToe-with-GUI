...
/**
 * This class is the view of the Tic-Tac-Toe setup screen
 * and allows you to configure your game.
...
public final class GameSetupScreen extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent event) {
        /*
         * Set cursor to indicate computation ongoing; this matters only if
